...
export default class NotebookEditor extends Component {
        ...
        <div className='editor-area'>
          <div className='left-panel' style={{width: this.state.leftPanelWidth}}>
            ...
            <DataTable
              ...
              dataVariables={activePicture.variables}
              onImport={this.handleImportModalToggle.bind(this)}
              dataValues={variableValues} />
          ...
          <ImportModal
            ...
            onClose={this.handleImportModalToggle.bind(this)}
            isShowing={this.state.isShowingImportModal} />
  ...
  handleImportModalToggle() {
    this.setState({ isShowingImportModal: !this.state.isShowingImportModal });
  }

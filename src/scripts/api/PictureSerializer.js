...
function setLineProperties(json, instruction) {
  if (instruction.to) {
    ...
    // TODO: change this to better names (perhaps horizontal/vertical)
...
// TODO: this should include the actual instruction list instead of just a
...
function instructionToJson(instruction) {
  ...
  json.type = instructionConstructorToTypeMap.get(instruction.constructor);
...
export default {pictureToJson, pictureFromJson};
